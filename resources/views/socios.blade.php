...
<body>
  <div class="container my-4">
    <h1 class="display-4">Socios de Coipu Rugby Club</h1>
    @if(session('mensaje'))
    ...
    <form action="{{route('crear')}}" method="POST">
      ...
      <button class="btn btn-primary btn-block" type="submit">Agregar Socio</button>
    </form><!--cierre form-->
    <table class="table">
      <thead>
        <tr>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
              ...
              <form action="{{ route('socios.eliminar' , $item)}}" method="POST" class="d-inline">
                @method('DELETE')
                @csrf
